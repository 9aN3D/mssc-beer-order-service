...
import static guru.springframework.mssc.beer.order.service.config.JmsConfig.DEALLOCATING_ORDER_QUEUE;
...
public interface EventProducer {
    ...
    default void produceToDeallocatingOrderQueue(DeallocateOrderRequest event) {
        produce(DEALLOCATING_ORDER_QUEUE, event);
    }
